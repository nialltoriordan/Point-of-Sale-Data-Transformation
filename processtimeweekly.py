	...
	for filename in files:
		if filename.startswith("TIME1") :
			...
			with open(os.path.join(root, filename), "r") as file :
				...
				if(overflowEve > 0) :  #if there's invalid morning hours add these to last valid hour 
					currentRow[18] += overflowEve
					currentRow[19] += overflowEvet
